...
const Contact = () => {
  ...
  return (
    <section id="contact" className={['my-24 md:my-0 py-16 md:py-16'].join(' ')}>
        ...
        <div className="py-16">
          <div className="flex flex-col flex-nowrap">
            ...
            <div className="flex flex-row justify-between w-full nowrap">
              <h2 className="alm-h2--projects">Let&apos;s have coffee some time</h2>
            </div>
            ...
            >
              If you want to hire me, ask me a question or just wanted to say hi. Send me a message
        ...
        <div className="flex flex-col md:flex-row flex-nowrap">
          <div className="flex flex-col gap-4 md:w-2/5 md:py-16 flex-nowrap">
            ...
            >
              ...
              <input type="hidden" name="_subject" value="Website: AlainMoratalla.com Message" />
            ...
            {formSubmitted && (
              <p className="p-4 bg-transparent border-2 border-success text-poppins">
                <span className="mb-2 font-bold text-md mt-2">Thank you for being awesome!</span>
                <br />
                <span>
                  I appreciate your message {formInputs.name}. I&apos;ll get back to you shortly and
                  reply by email as soon as possible.
                </span>
                <span className="block mt-2">Talk to you soon</span>
              </p>
            )}
          </div>
          <div className="flex flex-col flex-1 gap-4 py-16 md:w-1/2 md:p-16 md:ml-8 md:bg-off bg-inherit">
            <h4 className="text-2xl font-bold font-poppins">Get in touch some other way...</h4>
            <p>
              I&apos;m always open to opportunities and finding ways to improve myself. If you think
              I can provide any value for you in any way, you can also find me on the following
              sites.
            </p>
